...
const selectTriggerStyles = [
  cx(
    // base
    "group/trigger cursor-pointer flex w-full select-none items-center justify-between gap-2 truncate rounded-md border px-3 py-2 shadow-sm outline-none transition sm:text-sm",
    // border color

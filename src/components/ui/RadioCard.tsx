  ...
  return (
    <div
      className={cx(
        ...
        // checked
        "group-data-[state=checked]:border-0 group-data-[state=checked]:border-transparent group-data-[state=checked]:bg-blue-600",
        // disabled
...
>(({ className, children, ...props }, forwardedRef) => {
  return (
    <RadioGroupPrimitives.Item
      ...
      className={cx(
        // base
        "group relative w-full rounded-md border p-4 text-left shadow-sm transition-all focus:outline-none cursor-pointer",
        // background color
        "bg-white dark:bg-gray-950",
        // border color

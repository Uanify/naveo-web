...
export default function DriverSection() {
  return (
    <section
      id="driver"
      className="w-full flex items-center justify-center bg-[#FFFFFF] min-h-screen md:h-[90vh] py-20 md:py-0"
    >
      <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between px-6 md:px-0 gap-12 md:gap-0">
        <div className="flex flex-col gap-6 max-w-xl justify-center">
          <h1 className="text-4xl md:text-6xl font-medium leading-tight text-black">
            El copiloto digital para tu equipo de reparto.
          </h1>
          <p className="text-lg max-w-md text-[#525151]">
            Empodera a tus conductores con una app diseñada para el trabajo
            real. Navegación inteligente, gestión de pedidos en un solo toque y
            actualizaciones de estado al instante.
          </p>
          <Link
        ...
        <div className="flex justify-center md:justify-end items-center md:items-start w-full md:w-auto overflow-hidden">
          <div className="relative h-[600px] w-full max-w-[500px] md:h-[720px] md:w-[460px] md:max-w-none">
            <Image
              src="/banner-4-naveo.png"
              alt="banner naveo"
              fill
